...
export function AddDocs() {
    ...
    return (
        <div>
            ...
            <form className='flex flex-col py-2 md:flex-row md:items-end' onSubmit={onSubmit}>
                <label className='max-w-sm justify-start font-semibold uppercase text-secondary-focus md:mr-3'>Add document
                    <HorizontalLine />
                    <input name="file"
