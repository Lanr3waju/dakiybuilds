...
function UpdateLogForm({ setNewLog, setUpdateLog, newLog, currentLogID, log, setLog }) {
    ...
    return (
        <form onSubmit={submitNewLog}>
            ...
            <button disabled={isLoading} className='btn btn-success btn-xs '>{isLoading ? <span className="loading loading-dots loading-sm"></span> : "Update Log"}</button>
        </form>
    )
}
