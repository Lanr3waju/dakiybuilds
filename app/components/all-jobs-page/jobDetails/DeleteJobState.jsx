    ...
    return (
        <>
            ...
            <div className='mt-4 rounded-xl bg-error/40 p-4'>
                ...
                <p>Please enter the job title <span className='font-Roboto font-bold uppercase text-error'>&apos;{currentProject.name}&apos;</span> in the box below to verify your delete action.</p>
                <input className='input input-error my-3 w-full' type="text" onChange={handleInputChange} onPaste={handlePaste} />
                ...
                <button className='btn btn-warning mt-3 w-full' onClick={() => setDeleteState(false)}>Cancel</button>
            </div >
        </>
    )
}
