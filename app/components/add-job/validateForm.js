export const validateForm = (jobData) => {
    ...
    } else if (new Date(jobData.estimatedFinishDate) <= new Date(jobData.agreedStartDate)) {
        errors.estimatedFinishDate = 'Estimated Finish Date must be after Agreed Start Date'
    }
