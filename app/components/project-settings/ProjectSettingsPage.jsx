        ...
        <>
            ...
            <section className="mt-8">
                ...
                <section className="my-3 rounded-lg border-2 border-warning bg-warning/10 p-4 text-center">
                    <h3 className="my-3 font-semibold text-warning-content">This button logs you out of all your projects.</h3>
                    <button onClick={() => router.push('/')} className="btn btn-warning mx-auto mb-3 block w-full md:w-2/5">Logout</button>
                </section>

                <section className="my-3 rounded-lg border-2 border-error bg-error/10 p-4 text-center">
                    <h3 className="my-3 font-semibold text-warning-content">This button deletes the project and all the contained data from the database <span className="text-2xl font-bold text-error">‼</span></h3>
                    <button className="btn btn-error mx-auto mb-3 block w-full md:w-2/5">Delete this project</button>
                </section>
            </section>
        </>
    )
