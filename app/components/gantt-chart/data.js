                ...
                subtasks: [
                  {
                    ...
                    startDate: new Date('02/22/2019'),
                    endDate: new Date('02/24/2019'),
                    duration: 3,
                    progress: '50',
                    predecessor: '11FS',
                    resourceId: [3],
            ...
            subtasks: [
              {
                ...
                subtasks: [
                  ...
                  },
                  {
                    taskID: 27,
                    taskName: 'Customer review meeting',
                    startDate: new Date('03/07/2019'),
                    endDate: new Date('03/09/2019'),
                    duration: 2,
                    progress: '0',
                    predecessor: '26FS',
                    resourceId: [1],
...
exports.baselineData = [
  ...
  },
  {
    ...
    BaselineStartDate: new Date('03/05/2018 10:00:00 AM'),
    BaselineEndDate: new Date('03/05/2018 10:15:00 AM'),
  ...
  },
  {
    ...
    BaselineEndDate: new Date('03/05/2018 10:45:00 AM'),
    StartDate: new Date('03/05/2018 10:20:00 AM'),
    EndDate: new Date('03/05/2018 10:35:00 AM'),
  },
  {
    TaskId: 4,
    TaskName: 'Replace the oil filter',
    BaselineStartDate: new Date('03/05/2018 10:45:00 AM'),
    BaselineEndDate: new Date('03/05/2018 11:15:00 AM'),
  ...
  },
  {
    ...
    BaselineStartDate: new Date('03/05/2018 11:15:00 AM'),
    BaselineEndDate: new Date('03/05/2018 11:25:00 AM'),
    StartDate: new Date('03/05/2018 11:00:00 AM'),
    EndDate: new Date('03/05/2018 11:20:00 AM'),
  },
  {
    TaskId: 7,
    TaskName: 'Replace the cabin filter',
    BaselineStartDate: new Date('03/05/2018 11:00:00 AM'),
    BaselineEndDate: new Date('03/05/2018 11:20:00 AM'),
    StartDate: new Date('03/05/2018 11:00:00 AM'),
  ...
  },
  {
    ...
    BaselineStartDate: new Date('03/05/2018 11:00:00 AM'),
    BaselineEndDate: new Date('03/05/2018 11:30:00 AM'),
    StartDate: new Date('03/05/2018 11:25:00 AM'),
    EndDate: new Date('03/05/2018 11:45:00 AM'),
  },
  {
    TaskId: 9,
    TaskName: 'Check level and refill brake fluid/clutch fluid',
    BaselineStartDate: new Date('03/05/2018 11:20:00 AM'),
    BaselineEndDate: new Date('03/05/2018 11:40:00 AM'),
    StartDate: new Date('03/05/2018 11:30:00 AM'),
  ...
  },
  {
    ...
    BaselineEndDate: new Date('03/05/2018 12:00:00 PM'),
    StartDate: new Date('03/05/2018 11:50:00 AM'),
  ...
  },
  {
    ...
    BaselineEndDate: new Date('03/05/2018 12:35:00 PM'),
    StartDate: new Date('03/05/2018 11:50:00 AM'),
    EndDate: new Date('03/05/2018 12:20:00 PM'),
  },
  {
    ...
    BaselineStartDate: new Date('03/05/2018 12:20:00 PM'),
    BaselineEndDate: new Date('03/05/2018 12:35:00 PM'),
    StartDate: new Date('03/05/2018 12:20:00 PM'),
  ...
  },
  {
    ...
    BaselineEndDate: new Date('03/05/2018 1:00:00 PM'),
    StartDate: new Date('03/05/2018 12:45:00 PM'),
    EndDate: new Date('03/05/2018 1:00:00 PM'),
  },
  {
    TaskId: 15,
    TaskName: 'Wheel balancing',
    BaselineStartDate: new Date('03/05/2018 1:00:00 PM'),
    BaselineEndDate: new Date('03/05/2018 1:20:00 PM'),
    StartDate: new Date('03/05/2018 1:00:00 PM'),
    EndDate: new Date('03/05/2018 1:45:00 PM'),
  },
  {
    TaskId: 16,
    TaskName: 'Wheel alignment',
    BaselineStartDate: new Date('03/05/2018 1:20:00 PM'),
    BaselineEndDate: new Date('03/05/2018 1:45:00 PM'),
    StartDate: new Date('03/05/2018 1:45:00 PM'),
    EndDate: new Date('03/05/2018 2:45:00 PM'),
  },
  {
    TaskId: 17,
    TaskName: 'Check for proper operation of all lights, wipers etc.',
    BaselineStartDate: new Date('03/05/2018 1:50:00 PM'),
    BaselineEndDate: new Date('03/05/2018 02:30:00 PM'),
    StartDate: new Date('03/05/2018 02:45:00 PM'),
  ...
  },
  {
    ...
    BaselineEndDate: new Date('03/05/2018 3:30:00 PM'),
    StartDate: new Date('03/05/2018 03:30:00 PM'),
    EndDate: new Date('03/05/2018 04:15:00 PM'),
  },
  {
    TaskId: 19,
    TaskName: 'Use scan tool read trouble code',
    BaselineStartDate: new Date('03/05/2018 03:30:00 PM'),
    BaselineEndDate: new Date('03/05/2018 04:45:00 PM'),
    StartDate: new Date('03/05/2018 04:15:00 PM'),
    EndDate: new Date('03/05/2018 04:45:00 PM'),
  },
  {
    TaskId: 20,
    TaskName: 'Exterior washing',
    BaselineStartDate: new Date('03/05/2018 04:45:00 PM'),
    BaselineEndDate: new Date('03/05/2018 05:15:00 PM'),
    StartDate: new Date('03/05/2018 04:45:00 PM'),
    EndDate: new Date('03/05/2018 05:30:00 PM'),
  },
  {
    TaskId: 21,
    TaskName: 'Interior vacuuming',
    BaselineStartDate: new Date('03/05/2018 05:15:00 PM'),
    BaselineEndDate: new Date('03/05/2018 05:45:00 PM'),
    StartDate: new Date('03/05/2018 05:30:00 PM'),
    EndDate: new Date('03/05/2018 06:00:00 PM'),
  },
  {
    TaskId: 22,
    TaskName: 'Final service inspection',
    BaselineStartDate: new Date('03/05/2018 05:45:00 PM'),
    BaselineEndDate: new Date('03/05/2018 06:00:00 PM'),
    StartDate: new Date('03/05/2018 06:00:00 PM'),
    EndDate: new Date('03/05/2018 06:30:00 PM'),
  },
  {
    TaskId: 23,
    TaskName: 'Vehicle handover',
    BaselineStartDate: new Date('03/05/2018 06:00:00 PM'),
    BaselineEndDate: new Date('03/05/2018 06:00:00 PM'),
    StartDate: new Date('03/05/2018 06:30:00 PM'),
    EndDate: new Date('03/05/2018 06:30:00 PM'),
  },
]
exports.unscheduledData = [
...
exports.customizedData = [
  {
    ...
    Performance: 'Jimmy kimmel hosts the show',
    StartDate: new Date('03/05/2018 06:00:00 PM'),
    EndDate: new Date('03/05/2018 06:15:00 PM'),
  },
  {
    TaskId: 2,
    TaskName: 'Actor in a supporting role',
    Predecessor: '1FS',
    StartDate: new Date('03/05/2018 06:16:00 PM'),
    EndDate: new Date('03/05/2018 06:25:00 PM'),
    Winner: 'Sam Rockwell',
  ...
  },
  {
    ...
    Movie: 'Darkest Hour',
    Predecessor: '2FS',
    StartDate: new Date('03/05/2018 06:26:00 PM'),
    EndDate: new Date('03/05/2018 06:32:00 PM'),
  },
  {
    TaskId: 4,
    ...
    Predecessor: '3FS',
    StartDate: new Date('03/05/2018 06:33:00 PM'),
    EndDate: new Date('03/05/2018 06:40:00 PM'),
  },
  {
    TaskId: 5,
    ...
    Movie: ' Icarus',
    Predecessor: '4FS',
    StartDate: new Date('03/05/2018 06:41:00 PM'),
    EndDate: new Date('03/05/2018 06:58:00 PM'),
  },
  {
    TaskId: 6,
    ...
    Movie: 'Dunkirk',
    StartDate: new Date('03/05/2018 06:59:00 PM'),
    EndDate: new Date('03/05/2018 07:10:00 PM'),
    Predecessor: '5FS',
  },
  {
    TaskId: 7,
    ...
    Predecessor: '6FS',
    StartDate: new Date('03/05/2018 07:11:00 PM'),
    EndDate: new Date('03/05/2018 07:15:00 PM'),
  },
  {
    TaskId: 8,
    TaskName: 'Oscar performance',
    Performance: 'Second performance of the night is "Remember Me" from Coco',
    StartDate: new Date('03/05/2018 07:16:00 PM'),
    EndDate: new Date('03/05/2018 07:23:00 PM'),
    Predecessor: '7FS',
  },
  {
    TaskId: 9,
    ...
    Predecessor: '8FS',
    StartDate: new Date('03/05/2018 07:24:00 PM'),
    EndDate: new Date('03/05/2018 07:29:00 PM'),
  },
  {
    TaskId: 10,
    ...
    Movie: 'I, Tonya',
    StartDate: new Date('03/05/2018 07:30:00 PM'),
    EndDate: new Date('03/05/2018 07:35:00 PM'),
    Predecessor: '9FS',
  },
  {
    TaskId: 11,
    ...
    StartDate: new Date('03/05/2018 07:36:00 PM'),
    EndDate: new Date('03/05/2018 07:45:00 PM'),
    Predecessor: '10FS',
  },
  {
    TaskId: 12,
    ...
    Movie: 'Coco',
    Predecessor: '11FS',
    StartDate: new Date('03/05/2018 07:46:00 PM'),
    EndDate: new Date('03/05/2018 07:52:00 PM'),
  },
  {
    TaskId: 13,
    ...
    Predecessor: '12FS',
    StartDate: new Date('03/05/2018 07:53:00 PM'),
    EndDate: new Date('03/05/2018 07:56:00 PM'),
  },
  {
    TaskId: 14,
    ...
    Movie: 'Dunkirk',
    Predecessor: '13FS',
    StartDate: new Date('03/05/2018 07:57:00 PM'),
    EndDate: new Date('03/05/2018 07:59:00 PM'),
  },
  {
    TaskId: 15,
    TaskName: 'Oscar moments',
    Performance: 'Jimmy Kimmel surprises moviegoers along with celebrities',
    StartDate: new Date('03/05/2018 08:00:00 PM'),
    EndDate: new Date('03/05/2018 08:09:00 PM'),
    Predecessor: '14FS',
  },
  {
    TaskId: 16,
    ...
    Predecessor: '15FS',
    StartDate: new Date('03/05/2018 08:10:00 PM'),
    EndDate: new Date('03/05/2018 08:12:00 PM'),
  },
  {
    TaskId: 17,
    ...
    Predecessor: '16FS',
    StartDate: new Date('03/05/2018 08:13:00 PM'),
    EndDate: new Date('03/05/2018 08:15:00 PM'),
  },
  {
    TaskId: 18,
    TaskName: 'Oscar performance',
    Performance:
      'Jimmy Kimmel surprCommon and Andra Day performs "Stand Up for Something" by "Marshall"',
    StartDate: new Date('03/05/2018 08:16:00 PM'),
    EndDate: new Date('03/05/2018 08:25:00 PM'),
    Predecessor: '17FS',
  },
  {
    TaskId: 19,
    ...
    StartDate: new Date('03/05/2018 08:26:00 PM'),
    EndDate: new Date('03/05/2018 08:29:00 PM'),
    Predecessor: '18FS',
  },
  {
    TaskId: 20,
    ...
    StartDate: new Date('03/05/2018 08:30:00 PM'),
    EndDate: new Date('03/05/2018 08:35:00 PM'),
    Predecessor: '19FS',
  },
  {
    TaskId: 21,
    ...
    Winner: 'Jordan Peele',
    Movie: 'Get Out',
    StartDate: new Date('03/05/2018 08:36:00 PM'),
    EndDate: new Date('03/05/2018 08:44:00 PM'),
    Predecessor: '20FS',
  },
  {
    TaskId: 22,
    ...
    StartDate: new Date('03/05/2018 08:40:00 PM'),
    EndDate: new Date('03/05/2018 08:45:00 PM'),
    Predecessor: '21FS',
  },
  {
    TaskId: 23,
    ...
    Movie: 'Blade Runner 2049',
    StartDate: new Date('03/05/2018 08:46:00 PM'),
    EndDate: new Date('03/05/2018 08:48:00 PM'),
    Predecessor: '22FS',
  },
  {
    TaskId: 24,
    TaskName: 'Oscar performance',
    Performance:
      'Keala Settle performs the nominated song "This is Me" from "The Greatest Showman".',
    StartDate: new Date('03/05/2018 08:49:00 PM'),
    EndDate: new Date('03/05/2018 08:54:00 PM'),
    Predecessor: '23FS',
  },
  {
    TaskId: 25,
    ...
    Movie: 'The Shape of Water',
    Predecessor: '24FS',
    StartDate: new Date('03/05/2018 08:55:00 PM'),
    EndDate: new Date('03/05/2018 08:59:00 PM'),
  },
  {
    TaskId: 26,
    ...
    Movie: 'Coco',
    Predecessor: '25FS',
    StartDate: new Date('03/05/2018 09:00:00 PM'),
    EndDate: new Date('03/05/2018 09:07:00 PM'),
  },
  {
    TaskId: 27,
    TaskName: 'Oscar moments',
    Performance:
      'Time to pay tribute to those in the cinema world we lost last year',
    StartDate: new Date('03/05/2018 09:05:00 PM'),
    EndDate: new Date('03/05/2018 09:11:00 PM'),
    Predecessor: '26FS',
  },
  {
    TaskId: 28,
    ...
    Movie: 'The Shape of Water',
    StartDate: new Date('03/05/2018 09:12:00 PM'),
    EndDate: new Date('03/05/2018 09:19:00 PM'),
    Predecessor: '27FS',
  },
  {
    TaskId: 29,
    ...
    Winner: 'Gary Oldman',
    Movie: 'The Shape of Water',
    StartDate: new Date('03/05/2018 09:20:00 PM'),
    EndDate: new Date('03/05/2018 09:29:00 PM'),
    Predecessor: '28FS',
  },
  {
    TaskId: 30,
    ...
    Movie: 'Three Billboards Outside Ebbing, Missouri',
    StartDate: new Date('03/05/2018 09:30:00 PM'),
    EndDate: new Date('03/05/2018 09:44:00 PM'),
    Predecessor: '29FS',
  },
  {
    TaskId: 31,
    ...
    Movie: 'The Shape of Water',
    Predecessor: '30FS',
    StartDate: new Date('03/05/2018 09:45:00 PM'),
    EndDate: new Date('03/05/2018 10:00:00 PM'),
  },
  {
    TaskId: 32,
    TaskName: 'Oscar moments',
    ...
    Predecessor: '31FS',
    StartDate: new Date('03/05/2018 10:00:00 PM'),
    EndDate: new Date('03/05/2018 10:00:00 PM'),
    Duration: 0,
  },
]
exports.tooltipData = [
  {
    ...
    subtasks: [
      ...
      },
      {
        ...
        Predecessor: '3',
        Progress: 30,
        BaselineStartDate: new Date('04/06/2019'),
    ...
    subtasks: [
      {
        ...
        resources: 4,
        info: 'Develop floor plans and obtain a materials list for estimations',
        BaselineStartDate: new Date('04/05/2019'),
        BaselineEndDate: new Date('04/07/2019'),
      },
      {
        TaskID: 7,
        TaskName: 'List materials',
        ...
        resources: [4],
        info: '',
        BaselineStartDate: new Date('04/09/2019'),
      ...
      },
      {
        ...
        resources: [12],
        info: '',
        BaselineStartDate: new Date('04/16/2019'),
        BaselineEndDate: new Date('04/16/2019'),
      },
    ],
  },
  {
    ...
    info: 'If required obtain approval from HOA (homeowners association) or ARC (architectural review committee)',
    BaselineStartDate: new Date('04/16/2019'),
    BaselineEndDate: new Date('04/17/2019'),
  },
  {
    TaskID: 10,
    TaskName: 'Project approval and kick off',
    ...
    Duration: 0,
    Predecessor: '9',
    BaselineStartDate: new Date('04/17/2019'),
    BaselineEndDate: new Date('04/17/2019'),
  },
  {
    TaskID: 11,
    ...
    subtasks: [
      {
        ...
        info: 'Clear the building site (demolition of existing home if necessary)',
        BaselineStartDate: new Date('04/16/2019'),
        BaselineEndDate: new Date('04/18/2019'),
      },
      {
        TaskID: 13,
        TaskName: 'Install temporary power service',
        ...
        info: '',
        BaselineStartDate: new Date('04/17/2019'),
        BaselineEndDate: new Date('04/19/2019'),
      },
    ],
  },
]
