    ...
    return (
        <dialog id="forgot_password_modal" className="modal bg-primary-content/40">
            <form method="dialog" className="modal-box">
                ...
                <p className="mb-6">Please enter your email address to reset your password.</p>
                <div className="form-control">
                    ...
                    <input
                        ...
                        required
                    />
                    {emailError && <div className='mt-2 text-sm text-error/60'>{emailError}</div>}
                </div>
                <div className="modal-action">
                    <button onClick={() => window.forgot_password_modal.close()} type="button" className="btn btn-secondary">
                        Cancel
                    </button>
