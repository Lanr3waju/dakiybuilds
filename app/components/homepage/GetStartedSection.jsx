...
function GetStartedSection() {
    return (
        <section id='get-started' className=" md:flex bg-neutral px-4 py-12 text-white md:px-12 !scroll-smooth justify-between">
            <RequestDemoModal />
            <section className="w-full text-center md:w-3/6 md:text-left">
                ...
                <section>
                    ...
                    <ScrollRevealComponent>
                        <div className="my-1 md:text-xl text-3xl font-bold text-warning">OR</div>
                    </ScrollRevealComponent>
                    <ScrollRevealComponent>
                        <button className="btn btn-error btn-lg mx-auto mt-8 md:w-3/4 px-9 uppercase text-error-content w-full mb-8 md:mb-0" onClick={() => document.getElementById('request_demo_modal').showModal()}>Request a demo</button>
                    </ScrollRevealComponent>
                </section>
            </section>
            <HomePageLoginForm />
