  ...
  return (
    <section className="flex flex-col justify-center bg-gradient-to-b from-base-100 to-base-200 px-4 py-10 text-left md:flex-row md:px-2 md:py-16">
      ...
      <section className="md:mx-4 md:max-w-2xl md:text-left">
        <h2 className="font-Poppins text-2xl font-bold text-success/70 md:text-2xl md:font-extrabold">
        ...
        <p className="mx-auto py-4 font-Raleway text-xl font-normal leading-7 tracking-widest text-base-content/80  md:mx-0 md:max-w-[550px] md:py-2 md:font-light md:leading-8">
