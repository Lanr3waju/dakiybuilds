...
function HomePageLoginForm() {
    return (
        <section className="mt-5 max-w-xl rounded-md bg-base-200 px-2 py-9 leading-loose text-base-content shadow-md shadow-base-300 md:w-3/6">
            <h2 className="font-Poppins text-lg font-semibold text-base-content/70">Login to access your projects, or <Link className="link-primary link" href="/#">create new account:</Link></h2>
