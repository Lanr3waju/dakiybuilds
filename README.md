...
> Dakiybuilds is a web-based construction management system, for managing construction projects, this is a prototype to demonstrate DakiyBuilds.

> The construction management process in Nigeria and a lot of countries in Africa involves a lot of manual processes, and management of physical copies of documents, as well as having project managers, construction managers, contractors, builders etc. having to keep track of a lot of things in their head, all these results in poor project outcomes such as cost overruns and project delays.

> All of these problems can be greatly minimized using modern technologies, and that's why there is a need to create a modern solution specifically for Nigerians and Africans.
